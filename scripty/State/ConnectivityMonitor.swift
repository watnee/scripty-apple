...
//  network? — so the rest of the app can skip a request it is guaranteed to
//  lose, and can push held work the moment the route returns. The web client
//  probes a /health endpoint on a timer for the same answer; a native app gets
//  it straight from the system.
//
