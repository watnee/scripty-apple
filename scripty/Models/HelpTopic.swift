        ...
        HelpSection(id: "documents", title: "Documents", topics: [
            HelpTopic(
                ...
                paragraphs: [
                    ...
                    + "rename or delete it; touch and hold for everything else. The "
                    + "lists, the editors and the workspace each take the whole screen "
                    + "rather than a card over the script; Done, at the top left, is "
                    + "the way back.",
