        ...
        HelpSection(id: "documents", title: "Documents", topics: [
            HelpTopic(
                ...
                paragraphs: [
                    ...
                    + "trash for a file.",
                    "Folders group a long list. New Folder sits above the rows "
                    + "and names one; once there is a folder, the button beside "
                    + "it shows one folder at a time — All and Unfiled are there "
                    + "too, and renaming or removing the folder showing is in "
                    + "that same menu. "
