        ...
        HelpSection(id: "documents", title: "Documents", topics: [
            HelpTopic(
                ...
                paragraphs: [
                    ...
                    "The order of the songs is your own, and so is the order of the "
                    + "notes; either workspace screen will rearrange it. Arrange "
                    + "Songs and Arrange Notes, in the \u{201C}…\u{201D} menu there, "
                    + "set the writing aside and leave the titles to be dragged into "
                    + "the order you want by the grip beside each one; Done puts the "
                    + "writing back, still open at the ones you left open. For a "
                    + "single nudge there is no need for any of that — Move Up and "
                    + "Move Down, beside a title, move that one a place up or down "
                    + "where it stands. Either way the whole arrangement is saved, "
                    + "and a filter narrowing the screen moves only the documents you "
                    + "can see. Both lists rearrange the same way: Edit, then drag by "
                    + "the grip.",
