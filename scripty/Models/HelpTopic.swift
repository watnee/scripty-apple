        ...
        HelpSection(id: "documents", title: "Documents", topics: [
            HelpTopic(
                ...
                paragraphs: [
                    ...
                    + "Recordings, in the lyric editor's \u{201C}…\u{201D} menu, holds "
                    + "what this song sounds like — the voice memo you sang the tune "
                    + "into, the demo the band sent back, a reference track you are "
                    + "chasing. Add Recording takes an MP3, M4A, WAV, AIFF, FLAC or "
