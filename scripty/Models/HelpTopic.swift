        ...
        HelpSection(id: "reading", title: "Reading and Layout", topics: [
            ...
            HelpTopic(
                ...
                paragraphs: [
                    ...
                    + "the reader or the pages are up. The speaker steps aside once "
                    + "a reading starts — the transport below it has the pause — and "
                    + "comes back when the reading is closed. With a keyboard, ⌘⇧A starts a "
        ...
        HelpSection(id: "documents", title: "Documents", topics: [
            HelpTopic(
                ...
                paragraphs: [
                    ...
                    + "a verse can never rewind the script you left. In every song and "
                    + "note editor the pair sits in the top corner beside Done, "
                    + "where holding either one keeps walking that way a step at a time "
                    + "until you lift your finger or run out of history, and it is "
                    + "repeated in the bar above the keyboard while you are typing — the "
                    + "top bar folds away as you scroll down through a document and that "
                    + "bar does not, so the way back is always under your thumb. Each "
                    + "step says what it did, in a line that floats over the writing for "
                    + "a moment: what a step brings back may be a paragraph, or a title, "
                    + "that you cannot see from where you are standing. "
                    ...
                    + "another. A step that brings lines back says how many. "
                    + "On either workspace screen the pair sits "
                    ...
                    + "highlighted and scrolls itself into view, and holding a "
                    + "line offers \u{201C}Read Aloud From Here\u{201D} \u{2014} the third verse "
                    + "without the two before it. A reading started "
