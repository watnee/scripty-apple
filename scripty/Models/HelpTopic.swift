        ...
        HelpSection(id: "documents", title: "Documents", topics: [
            HelpTopic(
                ...
                paragraphs: [
                    ...
                    + "plain song editors the pair sits at the top of the screen, "
                    + "beside Done, and again at the left of the bar above the "
                    + "keyboard — the same two steps either way, so putting the "
                    + "keyboard down does not put undo away with it. They walk the "
                    + "words themselves: a burst of typing, "
