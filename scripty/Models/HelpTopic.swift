        ...
        HelpSection(id: "reading", title: "Reading and Layout", topics: [
            HelpTopic(
                ...
                paragraphs: [
                    ...
                    + "same place the Edit button had in the top corner on iPad and "
                    + "Mac, so one tap in that spot is whichever surface you are not "
                    + "on. Read Script is in the View menu as well, and on iPhone "
                    + "that is where to reach for it: the bar at the foot of the "
                    + "screen belongs to the reading and is not drawn over the "
                    + "writing column. Read Song and Read Note stay in a song or "
                    + "note's “…” menu.",
            ...
            HelpTopic(
                ...
                paragraphs: [
                    ...
                    + "underneath. On an iPhone the two sit side by side while you "
                    + "are reading: Page View is a button in the bar at the foot of "
                    + "the screen, beside Read Aloud, and while the pages are up the "
                    + "same button reads Read Script and brings the reading back. "
                    + "That bar belongs to the reading — it is not drawn over the "
                    + "writing column, where the View menu is the way to either. "
                    + "This is also the surface a "
                    ...
                    + "bar along the bottom while you are reading, and on every "
                    + "device, in every mode, it is in the “…” menu in the corner — "
                    + "which is where to start a reading from while you are writing. "
                    + "The element being read is highlighted "
